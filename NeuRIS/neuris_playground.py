...
def training(args):
  ...
  #runner.writer = SummaryWriter(log_dir=os.path.join(args.exp_dir, args.exp_name, 'logs'))
  runner.writer = SummaryWriter(log_dir="C:/Users/JTStephens/Downloads/replica/replica/test/office_0_1/runner")
  ...
  print(f"Starting training for {res_step} iterations.")

if __name__ == "__main__":
  parser = ArgumentParser(description="Run NeuRIS training")
  parser.add_argument("--scene_name", type=str, default="scene0625_00")
  parser.add_argument("--exp_name", type=str, default="runner_office_0_1")
  parser.add_argument("--exp_dir", type=str, default="/runner")
